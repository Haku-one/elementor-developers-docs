        ...
        jQuery(document).ready(function($) {
            ...
            function findVariation() {
                ...
                if (matchedVariation) {
                    ...
                    var priceHtml = matchedVariation.price_html || matchedVariation.display_price + ' руб.';
                    container.find('.single_variation').html('<div class="woocommerce-variation-price">' + priceHtml + '</div>');
